<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('pagina_internet') }}
            {{ Form::text('pagina_internet', $empresa->pagina_internet, ['class' => 'form-control' . ($errors->has('pagina_internet') ? ' is-invalid' : ''), 'placeholder' => 'Pagina Internet']) }}
            {!! $errors->first('pagina_internet', '<div class="invalid-feedback">:message</div>') !!}
        </div>
