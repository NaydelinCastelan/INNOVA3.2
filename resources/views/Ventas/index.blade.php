                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6 col-md-4 mb-5">
                                <a href="{{ route('pendientes') }}" target="_blank">
                                    <img src="/assets/images/pendientes.png" alt="Plan Form" class="img-thumbnail">
                                    <h4 class="d-block mt-3 mb-0 center">Pedidos pendientes</h4>
                                </a>
                            </div>
                            <div class="col-12 col-sm-6 col-md-4 mb-5">
                                <a href="{{ route('completados') }}" target="_blank">
                                    <img src="/assets/images/completadas.png" alt="Floating Contact Form" class="img-thumbnail">
                                    <h4 class="d-block mt-3 mb-0 center">Pedidos completados</h4>
                                </a>
                            </div>
                            <div class="col-12 col-sm-6 col-md-4 mb-5">
                                <a href="forms-booking-reservation.html" target="_blank">
